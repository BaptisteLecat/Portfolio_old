...
class ProjectManager
{
    public static function selectProject()
    {
        ...
        try {
            ...
            while ($result = $request->fetch()) {
                ...
                $category = CategoryManager::selectCategoryFromId($result["project_idCategory"]);
    ...
    public static function loadTechnologyForCategory(Project $project)
    {
        try {
            $request = PdoFactory::getPdo()->prepare("SELECT technology.technology_id, technology.technology_label, technology.technology_picture FROM technology, project_technology WHERE technology.technology_id = project_technology.technology_id AND project_technology.category_id = :project_id");
